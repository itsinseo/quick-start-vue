...
<template>
	<section class="todoapp">
		...
		<footer class="footer" v-show="todos.length">
			...
			<button class="clear-button" @click="clearLocalStorage">Clear All</button>
			<button class="clear-button" @click="removeCompleted" v-show="todos.length > remaining">
				Clear completed
			</button>
		</footer>
	</section>
